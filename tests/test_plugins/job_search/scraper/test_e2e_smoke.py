...
Run explicitly with::
    ...
    pytest -m smoke tests/test_plugins/job_search/scraper/test_e2e_smoke.py
...
from daily_driver.plugins.job_search.scraper.sources.remoteok import scrape_remoteok
